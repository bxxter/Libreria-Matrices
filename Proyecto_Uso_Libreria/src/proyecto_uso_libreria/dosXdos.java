...
public class dosXdos extends javax.swing.JFrame {
    ...
    A[1][0] = Double.parseDouble(A3.getText());
    A[1][1] = Double.parseDouble(A4.getText());

    B[0][0] = Double.parseDouble(B1.getText());
    B[0][1] = Double.parseDouble(B2.getText());
    B[1][0] = Double.parseDouble(B3.getText());
    B[1][1] = Double.parseDouble(B4.getText());
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(dosXdos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

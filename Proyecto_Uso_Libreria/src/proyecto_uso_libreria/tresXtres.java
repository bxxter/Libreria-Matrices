...
public class tresXtres extends javax.swing.JFrame {

    double[][] A;
    double[][] B;
    /**
     * Creates new form dosXdos
     */
    public tresXtres() {
        initComponents();
     ...
     private void obtenerValoresMatrices() {
        ...
        A[1][0] = Double.parseDouble(A4.getText());
        A[1][1] = Double.parseDouble(A5.getText());
        A[1][2] = Double.parseDouble(A6.getText());
        A[2][0] = Double.parseDouble(A7.getText());
        A[2][1] = Double.parseDouble(A8.getText());
        A[2][2] = Double.parseDouble(A9.getText());

        // Matriz B
        B[0][0] = Double.parseDouble(B1.getText());
        B[0][1] = Double.parseDouble(B2.getText());
        B[0][2] = Double.parseDouble(B3.getText());
        B[1][0] = Double.parseDouble(B4.getText());
        B[1][1] = Double.parseDouble(B5.getText());
        B[1][2] = Double.parseDouble(B6.getText());
        B[2][0] = Double.parseDouble(B7.getText());
        B[2][1] = Double.parseDouble(B8.getText());
        B[2][2] = Double.parseDouble(B9.getText());
    }
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                    ...
                                    .addComponent(B4, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 71, Short.MAX_VALUE))
                                .addGap(18, 18, 18)
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(B5, javax.swing.GroupLayout.DEFAULT_SIZE, 71, Short.MAX_VALUE)
                                    .addComponent(B8))
                                .addGap(18, 18, 18)
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(B6)
    ...
    private void btnAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAceptarActionPerformed
        ...
        A5.getText().isEmpty()||A6.getText().isEmpty()||
        A7.getText().isEmpty()||A8.getText().isEmpty()||
        A9.getText().isEmpty()||
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(tresXtres.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
